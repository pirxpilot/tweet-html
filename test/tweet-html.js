...
test('should parse urls and hashtags', function(t) {
  var html = [
    '<a href="https://twitter.com/KillingtonMtn/status/412708201784569856" target="_blank" rel="noopener" class="date">',
      '3 days ago',
    '</a>',
    '<div class="text">',
...
test('should parse user mentions', function(t) {
  var html = [
    '<a href="https://twitter.com/Alta/status/413730533345337344" target="_blank" rel="noopener" class="date">',
      '3 days ago</a>',
    '<div class="text">',
    'Last chance to purchase your ',
    '<a href="https://twitter.com/intent/user?user_id=741553663" target="_blank" rel="noopener">@Mountain Collective</a> ',
    'and make this the best season yet! ',
    '<a href="http://ow.ly/rVl4M" target="_blank" rel="noopener">ow.ly/rVl4M</a> ',
...
test('should parse photos', function(t) {
  var html = [
    '<a href="https://twitter.com/KillingtonMtn/status/413306301343465473" target="_blank" rel="noopener" class="date">',
      '3 days ago',
    '</a>',
    '<div class="text">',
      'Bear Mountain OPENS this afternoon. Check the conditions page for the latest information. ',
      '<a href="http://www.killington.com/conditions" target="_blank" rel="noopener">killington.com/conditions</a> ',
    '</div>',
    '<a href="http://twitter.com/KillingtonMtn/status/413306301343465473/photo/1" target="_blank" rel="noopener" class="photo">',
...
test('should parse vine', function(t) {
  var html = [
    '<a href="https://twitter.com/stratton/status/413684211087048704" target="_blank" rel="noopener" class="date">',
      '3 days ago',
    '</a>',
...
test('should parse youtube videos', function(t) {
  var html = [
    '<a href="https://twitter.com/stratton/status/413440560104345600" target="_blank" rel="noopener" class="date">',
    '3 days ago</a>',
...
test('should parse youtube videos with extra params', function(t) {
  var html = [
    '<a href="https://twitter.com/stratton/status/418773517224521729" target="_blank" rel="noopener" class="date">',
    '3 days ago',
    '</a>',
    '<div class="text">',
...
test('should parse vimeo videos', function(t) {
  var html = [
    '<a href="https://twitter.com/telluride/status/414158499073908737" target="_blank" rel="noopener" class="date">',
    '3 days ago',
    '</a>',
    '<div class="text">',
...
test('should parse instagrams', function(t) {
  var html = [
    '<a href="https://twitter.com/KillingtonMtn/status/413793572409061376" target="_blank" rel="noopener" class="date">',
      '3 days ago',
    '</a>',
    '<div class="text">',
...
test('should parse extended tweet format', function(t) {
  var html = [
    '<a href="https://twitter.com/Furkot/status/793223177853931554" target="_blank" rel="noopener" class="date">',
      '3 days ago',
    '</a>',
    '<div class="text">',
      'New feature: we support <a href="https://twitter.com/intent/user?user_id=15324722" target="_blank" rel="noopener">@Garmin</a>',
      ' CSV format for imports.\n',
      'Which means you can now use CSV files from ',
      '<a href="https://twitter.com/intent/user?user_id=515999124" target="_blank" rel="noopener">@POI_Factory</a>\n',
...
test('should parse native video', function(t) {
  var html = [
    '<a href="https://twitter.com/bigskyresort/status/919977363235991552" target="_blank" rel="noopener" class="date">',
      '3 days ago',
    '</a>',
    '<div class="text">',
      'The Big 5 is the best deal of the year! Save 20% on a 5 day lift ticket. ',
...
test('should extended compatibility stream events', function(t) {
  var html = [
    '<a href="https://twitter.com/PUBG_help/status/960897321608339456" target="_blank" rel="noopener" class="date">',
      '3 days ago',
    '</a>',
    '<div class="text">',
      '<a href="https://twitter.com/intent/user?user_id=948192552" target="_blank" rel="noopener">',
        '@Alejandro LeGnØ',
      '</a>',
      ...
      '\n',
      '\n',
      '<a href="https://pubgsupport.zendesk.com/hc/en-us" target="_blank" rel="noopener">',
